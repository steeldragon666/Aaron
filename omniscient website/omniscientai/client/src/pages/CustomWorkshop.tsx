      ...
      <div className="container max-w-3xl">
        ...
        {submitted ? (
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="glass-card rounded-2xl p-8 text-center">
            ...
            <p className="text-[#888888] mb-6">Thank you for your interest. We'll review your requirements and get back to you within 24 hours with a tailored proposal.</p>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input type="text" className="w-full px-4 py-3 rounded-lg bg-[#0A0A0A] border border-[#333333] text-[#E8E8E8] placeholder-[#888888] focus:border-[#12B5CB] focus:outline-none transition-colors" placeholder="e.g. 10-15 people" />
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-[#E8E8E8] mb-2">Industry</label>
              <input type="text" className="w-full px-4 py-3 rounded-lg bg-[#0A0A0A] border border-[#333333] text-[#E8E8E8] placeholder-[#888888] focus:border-[#12B5CB] focus:outline-none transition-colors" placeholder="e.g. Legal, Healthcare, Manufacturing" />
            </div>
            <div>
              <label className="block text-sm font-medium text-[#E8E8E8] mb-2">What are your learning objectives? *</label>
              <textarea required rows={4} className="w-full px-4 py-3 rounded-lg bg-[#0A0A0A] border border-[#333333] text-[#E8E8E8] placeholder-[#888888] focus:border-[#12B5CB] focus:outline-none transition-colors resize-none" placeholder="Tell us about your team's goals, current AI experience, and what you'd like to achieve..." />
            </div>
            <button
              type="submit"
