    ...
    <>
      <section className="relative pt-28 pb-16 overflow-hidden">
        ...
        <div className="container relative">
          <Link href="/industries" className="inline-flex items-center gap-1 text-sm text-[#888888] hover:text-[#12B5CB] transition-colors mb-6">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm text-[#888888]">{ind.statLabel}</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-[#E8E8E8] mb-3" style={{ fontFamily: "var(--font-heading)" }}>
              AI for {ind.title}
            </h1>
            <p className="text-lg text-[#888888]">{ind.subtitle}</p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="lg:col-span-1">
            <div className="lg:sticky lg:top-24">
              <div className="glass-card rounded-2xl p-6 glow-cyan">
                ...
                <p className="text-sm text-[#888888] mb-6">Book a free strategy session to discuss AI opportunities specific to {ind.title.toLowerCase()}.</p>
                <Link
                  href="/book"
